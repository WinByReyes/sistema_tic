...
public class CatalogoService {
    ...
    @Transactional
    public Catalogo crear(
            CatalogoRequestDTO datos) {

        if (datos == null) {

            throw new IllegalArgumentException(
                    "Los datos del catálogo son obligatorios."
            );
        ...
        if (
            ...
            throw new IllegalArgumentException(
                    "Ya existe este valor en el catálogo: "
                            + nombre
            );
